...
@Component({
  selector: 'Starship-home',
  templateUrl: './Starship-home.component.html',
  styleUrls: ['./Starship-home.component.scss']
})
export class StarshipHomeComponent implements AfterViewInit {
