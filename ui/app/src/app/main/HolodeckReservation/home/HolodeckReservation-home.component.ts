...
@Component({
  selector: 'HolodeckReservation-home',
  templateUrl: './HolodeckReservation-home.component.html',
  styleUrls: ['./HolodeckReservation-home.component.scss']
})
export class HolodeckReservationHomeComponent implements AfterViewInit {
