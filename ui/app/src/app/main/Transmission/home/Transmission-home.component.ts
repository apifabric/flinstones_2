...
@Component({
  selector: 'Transmission-home',
  templateUrl: './Transmission-home.component.html',
  styleUrls: ['./Transmission-home.component.scss']
})
export class TransmissionHomeComponent implements AfterViewInit {
