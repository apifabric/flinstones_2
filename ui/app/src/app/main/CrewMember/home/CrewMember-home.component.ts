...
@Component({
  selector: 'CrewMember-home',
  templateUrl: './CrewMember-home.component.html',
  styleUrls: ['./CrewMember-home.component.scss']
})
export class CrewMemberHomeComponent implements AfterViewInit {
