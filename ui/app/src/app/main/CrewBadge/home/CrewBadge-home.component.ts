...
@Component({
  selector: 'CrewBadge-home',
  templateUrl: './CrewBadge-home.component.html',
  styleUrls: ['./CrewBadge-home.component.scss']
})
export class CrewBadgeHomeComponent implements AfterViewInit {
