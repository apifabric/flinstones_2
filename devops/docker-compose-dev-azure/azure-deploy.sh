...
resourcename="flinstones2"  # lower case, only
resourcegroup="flinstones2_rg"
...
# git clone https://github.com/apilogicserver/flinstones2.git
# cd flinstones2
...
az group create --name flinstones2_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group flinstones2_rg --sku S1 --is-linux
az container create --resource-group flinstones2_rg --name flinstones2 --image apilogicserver/flinstones2:latest --dns-name-label flinstones2 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//flinstones2.westus.azurecontainer.io:5656'
